<template>
  <nav class="va-navbar">
    <div class="va-navbar__icon-container">
      ...
      <img src="@/assets/img/fold.svg" style="cursor: pointer" @click="handleClickMinimized" />
      <!-- <span class="flex-center header-selector i-menu-expanded"></span> -->
    </div>
...
export default {
  ...
  methods: {
    handleClickMinimized() {
      // this.$emit('update:minimized', !this.minimized);
      this.$store.dispatch("changeMinimized");
    }
  }
};
</script>
...
<style lang="scss">
@import "../../until-sass/resources/resources";
...
.va-navbar {
  ...
  .va-navbar__icon-container {
    // .i-menu-expanded {
    //   // background: url(../img/maid.png) no-repeat 50%;
    // }
    // .i-menu-expanded {
